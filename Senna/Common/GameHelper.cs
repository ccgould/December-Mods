...
namespace Common
{
    public static class GameHelper
    {
        ...
        public static GameObject GetPrefabClone(this GameObject prefab, Transform parent)
        {
            bool isActive = prefab.activeSelf;
        ...
        public static GameObject GetPrefabClone(this GameObject prefab, Transform parent, bool active)
        {
            bool isActive = prefab.activeSelf;
        ...
        public static GameObject GetPrefabClone(this GameObject prefab, Transform parent, bool active, string newName)
        {
            bool isActive = prefab.activeSelf;
        ...
        public static T GetObjectClone<T>(this T uEobject, Transform parent) where T : UnityEngine.Component
        {
            T clone = UnityEngine.Object.Instantiate(uEobject);
            clone.transform.parent = parent;
            Utils.ZeroTransform(clone.transform);
            return clone;
        }        
        ...
        public static GameObject CreateGameObject(PrimitiveType primitiveType, string name, Transform parent, Vector3 localPos)
        {
            GameObject newObject = GameObject.CreatePrimitive(primitiveType);
            newObject.name = name;
            newObject.transform.parent = parent;
        ...
        public static GameObject CreateGameObject(PrimitiveType primitiveType, string name, Transform parent, Vector3 localPos, Vector3 localRot)
        {
            GameObject newObject = GameObject.CreatePrimitive(primitiveType);
            newObject.name = name;
            newObject.transform.parent = parent;            
